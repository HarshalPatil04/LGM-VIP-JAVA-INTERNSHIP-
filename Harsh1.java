...
public class Harsh1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 20, 147), 5));
        ...
        jLabel2.setFont(new java.awt.Font("SANS_SERIF", 1, 14));
        jLabel2.setText("From currency Of");

        jLabel3.setFont(new java.awt.Font("SANS_SERIF", 1, 14));
        jLabel3.setText("To currency Of");

        t1.setFont(new java.awt.Font("SANS_SERIF", 1, 18));

        t2.setFont(new java.awt.Font("SANS_SERIF", 1, 18));

        jButton1.setFont(new java.awt.Font("SANS_SERIF", 1, 18));
        ...
        jButton2.setFont(new java.awt.Font("SANS_SERIF", 1, 18)); // NOI18N
        ...
        jButton3.setFont(new java.awt.Font("SANS_SERIF", 1, 18)); // NOI18N
        ...
        secondCurrencyUnit.setFont(new java.awt.Font("SANS_SERIF", 1, 14)); // NOI18N
        secondCurrencyUnit.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        secondCurrencyUnit.setText("units");

        firstCurrencyUnit.setFont(new java.awt.Font("SANS_SERIF", 1, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Harsh1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
